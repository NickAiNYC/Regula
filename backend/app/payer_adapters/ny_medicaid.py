...
class NYMedicaidAdapter(BasePayerAdapter):
    ...
    async def get_allowed_amount(
        ...
        **kwargs
        ...
        geo_factor = self.get_geographic_adjustment_factor(geo_region or "upstate", service_date)
    ...
    async def detect_underpayment(
        ...
        **kwargs
        ...
        return {
            ...
            "paid_amount": paid_amount,
            "delta": delta,
            "reason": "Payment below NY Medicaid parity mandate rate" if is_violation else None,
            "violation_codes": violation_codes,
            "geo_adjustment_factor": self.get_geographic_adjustment_factor(geo_region or "upstate", service_date)
        }
    ...
    async def _get_base_rate(self, cpt_code: str, service_date: date) -> Optional[Decimal]:
        """
        ...
        rates_database = {
            ...
            "90792": Decimal("187.29"),  # Psychiatric diagnostic eval with medical services
            ...
            "90840": Decimal("59.00"),   # Psychotherapy for crisis, each additional 30 min
