...
class AppealPipeline:
    ...
    async def process_violation(
        self, claim_data: Dict, violation_data: Dict, auto_submit: bool = False
    ) -> Dict:
        """
    ...
    async def _analyze_opportunity(self, context: Dict) -> Dict:
        ...
        """
        logger.info(
            "appeal_step_analyze", claim_id=context["claim_data"].get("claim_id")
        )

        analysis = await self.optimizer.analyze_appeal_opportunity(
            claim_data=context["claim_data"], violation_data=context["violation_data"]
        )
    ...
    async def _queue_for_review(self, context: Dict) -> Dict:
        ...
        review_item = {
            ...
            "status": (
                "pending_review" if not context["auto_submit"] else "auto_approved"
            ),
    ...
    async def _generate_documents(self, context: Dict) -> Dict:
        ...
        """
        logger.info(
            "appeal_step_generate", claim_id=context["claim_data"].get("claim_id")
        )
    ...
    async def _prepare_submission(self, context: Dict) -> Dict:
        ...
        """
        logger.info(
            "appeal_step_prepare", claim_id=context["claim_data"].get("claim_id")
        )
    ...
    async def _submit_appeal(self, context: Dict) -> Dict:
        ...
        """
        logger.info(
            "appeal_step_submit", claim_id=context["claim_data"].get("claim_id")
        )
    ...
    async def _track_status(self, context: Dict) -> Dict:
        ...
        logger.info(
            "appeal_tracking_initialized", appeal_id=tracking_record["appeal_id"]
        )
    ...
    def _generate_rate_worksheet(self, claim_data: Dict, violation_data: Dict) -> Dict:
        """Generate rate calculation worksheet"""
        return {
            ...
            "geo_adjustment_factor": float(
                violation_data.get("geo_adjustment_factor", 1.0)
            ),
